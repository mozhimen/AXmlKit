package com.mozhimen.xmlk.layoutk.video
...
import com.mozhimen.xmlk.layoutk.video.cons.CVideoGravity
...
class LayoutKVideo @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private var _videoGravity = CVideoGravity.NONE
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        _videoGravity =
            typedArray.getInt(R.styleable.LayoutKVideo_layoutKVideo_videoGravity, CVideoGravity.CENTER_CROP)
        _videoIsLoop =
    ...
    override fun initView() {
        ...
        if (_videoGravity != CVideoGravity.NONE) {
            zoomVideoSize()
            zoomTextureSize()
        }
    }
    ...
    fun initVideo(
        pathOrUrl: String,
        videoGravity: Int = CVideoGravity.NONE,
