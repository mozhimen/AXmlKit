...
class LayoutKAmount @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : BaseLayoutKLinear(context, attrs, defStyleAttr) {
    ...
    private object LayoutKAmountParser : IAttrsParser2<MAmountAttrs> {
        ...
        val AMOUNT_TEXT_COLOR: Int = UtilKRes.gainColor(com.mozhimen.xmlk.R.color.cok_blue_287ff1)
        ...
        val BTN_TEXT_COLOR: Int = UtilKRes.gainColor(com.mozhimen.xmlk.R.color.cok_blue_287ff1)
        val BTN_TEXT_SIZE: Int = 14f.sp2px().toInt()
        val BTN_BACKGROUND_COLOR: Int = UtilKRes.gainColor(com.mozhimen.xmlk.R.color.cok_gray_d2d4d7)
