...
internal object AttrsParser : IAttrsParser2<MNavBarAttrs> {
    ...
    private val SUBTITLE_TEXT_COLOR = UtilKRes.gainColor(com.mozhimen.uicorek.R.color.cok_gray_d2d4d7)
    private val SUBTITLE_TEXT_MARGIN_TOP = 1f.dp2px().toInt()
    private val LINE_COLOR = UtilKRes.gainColor(com.mozhimen.uicorek.R.color.cok_gray_eeeeee)
