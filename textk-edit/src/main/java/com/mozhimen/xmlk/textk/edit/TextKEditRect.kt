...
class TextKEditRect @JvmOverloads constructor(context: Context, attrs: AttributeSet?=null,defStyleAttr:Int = 0) :
    AppCompatEditText(context, attrs,defStyleAttr),IXmlK {
    ...
    override fun initAttrs(attrs: AttributeSet?) {
        ...
        _rectStateDrawable =
            typedArray.getDrawable(R.styleable.TextKEditRect_textKEditRect_rectStateDrawable)?: resources.getDrawable(R.drawable.textk_edit_rect_bg)
        ...
        _cursorStateDrawable =
            typedArray.getDrawable(R.styleable.TextKEditRect_textKEditRect_cursorStateDrawable)?: resources.getDrawable(R.drawable.textk_edit_rect_cursor)
        typedArray.recycle()
    }
...
//        setBackgroundColor(Color.TRANSPARENT)
    ...
    override fun onTextChanged(text: CharSequence?, start: Int, lengthBefore: Int, lengthAfter: Int) {
        ...
        if (textLength == _rectNum) {
            clearFocus()
            if (windowToken!=null){
                UtilKInputMethodManager.hideSoftInputFromWindow(windowToken,CInputMethodManager.HIDE_NOT_ALWAYS,context)
            }
