...
class LayoutKEditItem @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : BaseLayoutKLinear(context, attrs, defStyleAttr) {
    ...
    private fun parseTitleStyle(intResStyle: Int, title: String?) {
        ...
        val titleColor: Int =
            typedArray.getColor(R.styleable.LayoutKEditItem_TitleAppearance_titleAppearance_titleColor, UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_287ff1))
        val titleSize: Float =
    ...
    private fun parseInputStyle(intResStyle: Int, hint: String?, inputType: Int) {
        ...
        val hintColor: Int =
            typedArray.getColor(R.styleable.LayoutKEditItem_EditAppearance_inputAppearance_hintColor, UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_e8f3ff))
        val inputColor: Int =
            typedArray.getColor(R.styleable.LayoutKEditItem_EditAppearance_inputAppearance_inputColor, UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_287ff1))
        val inputSize: Int =
    ...
    private fun parseLineStyle(intResStyle: Int): CrossLine? {
        ...
        line.color =
            typedArray.getColor(R.styleable.LayoutKEditItem_LineAppearance_lineAppearance_color, UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_287ff1))
        line.height =
