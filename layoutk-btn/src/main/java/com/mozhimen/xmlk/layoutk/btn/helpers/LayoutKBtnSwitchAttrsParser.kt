...
object LayoutKBtnSwitchAttrsParser : IAttrsParser<LayoutKBtnSwitchAttrs> {
    val BG_COLOR_ON = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_287ff1)
    val BG_COLOR_OFF = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_e8f3ff)
    val BTN_COLOR = UtilKRes.gainColor(android.R.color.white)
    val BTN_MARGIN = 3f.dp2px()
    val BORDER_COLOR = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_e8f3ff)
