package com.mozhimen.uicorek.bark.rating;
...
import com.mozhimen.uicorek.drawablek.bases.BaseDrawableK;
import com.mozhimen.uicorek.drawablek.DrawableKStar;
...
public class BarKRating extends RatingBar {
    ...
    private DrawableKStar mDrawable;
...
//                R.styleable.AndRatingBar, defStyleAttr, 0);
        ...
        mDrawable = new DrawableKStar(context, mStarDrawable, mBgDrawable, mKeepOriginColor);
    ...
    private void applyTintForDrawable(Drawable drawable, ColorStateList tintList) {
        if (tintList != null) {
            if (drawable instanceof BaseDrawableK) {
