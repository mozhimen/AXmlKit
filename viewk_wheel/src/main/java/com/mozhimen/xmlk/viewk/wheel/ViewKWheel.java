package com.mozhimen.xmlk.viewk.wheel;
...
import com.mozhimen.xmlk.viewk.wheel.commons.IItemSelectedListener;
import com.mozhimen.xmlk.viewk.wheel.helpers.InertiaTimerTask;
import com.mozhimen.xmlk.viewk.wheel.helpers.MessageHandler;
import com.mozhimen.xmlk.viewk.wheel.helpers.SmoothScrollTimerTask;
...
public class ViewKWheel extends View {
    ...
    public ViewKWheel(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(com.mozhimen.xmlk.R.dimen.sp_20);//默认大小
