 ...
 */
class ImageKShimmer : androidx.appcompat.widget.AppCompatImageView, IXmlK, IImageKShimmer<ImageKShimmer> {
...
//    }
    ...
    override fun setShimmerConfig(shimmerConfig: DrawableKShimmer.ShimmerConfig): ImageKShimmer {
