...
import com.takusemba.spotlightsample.databinding.FragmentFragmentSampleBinding

class SampleFragmentFragment : BaseFragmentVB<FragmentFragmentSampleBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        vb.start.setOnClickListener { startButton ->
            ...
            // first target
            val view1 = layoutInflater.inflate(R.layout.layout_target, FrameLayout(requireContext()))
            ...
            // second target
            val view2 = layoutInflater.inflate(R.layout.layout_target, FrameLayout(requireContext()))
            ...
            // third target
            val view3=layoutInflater.inflate(R.layout.layout_target, FrameLayout(requireContext()))
            ...
            val guideProcess = GuideProcess.Builder()
                .setSteps(guideSteps)
                .setBackgroundColorRes(R.color.spotlightBackground, requireContext())
                .setDuration(1000L)
