 ...
 */
public class RecyclerKLooperLinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    int mOrientation = androidx.recyclerview.widget.RecyclerView.HORIZONTAL;
     ...
     */
    public RecyclerKLooperLinearLayoutManager(
    ...
    public RecyclerKLooperLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                               int defStyleRes) {
...
//            }
    ...
    private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback =
            new ViewBoundsCheck.Callback() {
                ...
                public View getChildAt(int index) {
                    return RecyclerKLooperLinearLayoutManager.this.getChildAt(index);
                }

                @Override
                public int getParentStart() {
                    return RecyclerKLooperLinearLayoutManager.this.getPaddingLeft();
                }

                @Override
                public int getParentEnd() {
                    return RecyclerKLooperLinearLayoutManager.this.getWidth() - RecyclerKLooperLinearLayoutManager.this.getPaddingRight();
                }
                ...
                public int getChildStart(View view) {
                    ...
                    return RecyclerKLooperLinearLayoutManager.this.getDecoratedLeft(view) - params.leftMargin;
                }
                ...
                public int getChildEnd(View view) {
                    final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                            view.getLayoutParams();
                    return RecyclerKLooperLinearLayoutManager.this.getDecoratedRight(view) + params.rightMargin;
                }
            };
    ...
    private final ViewBoundsCheck.Callback mVerticalBoundCheckCallback =
            new ViewBoundsCheck.Callback() {
                ...
                @Override
                public int getParentStart() {
                    return RecyclerKLooperLinearLayoutManager.this.getPaddingTop();
                }

                @Override
                public int getParentEnd() {
                    return RecyclerKLooperLinearLayoutManager.this.getHeight()
                            - RecyclerKLooperLinearLayoutManager.this.getPaddingBottom();
                }
                ...
                public int getChildStart(View view) {
                    final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                            view.getLayoutParams();
                    return RecyclerKLooperLinearLayoutManager.this.getDecoratedTop(view) - params.topMargin;
                }
                ...
                public int getChildEnd(View view) {
                    final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                            view.getLayoutParams();
                    return RecyclerKLooperLinearLayoutManager.this.getDecoratedBottom(view) + params.bottomMargin;
                }
            };
     ...
     * {@link RecyclerKLooperLinearLayoutManager#findOneVisibleChild(int, int, boolean, boolean)},
     * and {@link RecyclerKLooperLinearLayoutManager#findOnePartiallyOrCompletelyInvisibleChild(int, int)}.
     */
