 ...
 * @Version 1.0
 */
class RecyclerKLayoutManagerGridDynamic @JvmOverloads constructor(context: Context,
                                                                  private val scaling: Int = 2) : RecyclerKLayoutManagerGridCatch(context, 1, VERTICAL, false) {
