...
class RecyclerKLinearVDB @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : RecyclerView(context, attrs, defStyleAttr), IRecyclerKLinear {
    ...
    private inner class RecyclerKLinearItem(
    ...
    ) : RecyclerKItem<VHKLifecycle2VDB<RecyclerkLinearItemBinding>>() {

        override fun onBindItem(holder: VHKLifecycle2VDB<RecyclerkLinearItemBinding>, position: Int) {
        ...
        override fun onCreateViewHolder(parent: ViewGroup): VHKLifecycle2VDB<RecyclerkLinearItemBinding> {
