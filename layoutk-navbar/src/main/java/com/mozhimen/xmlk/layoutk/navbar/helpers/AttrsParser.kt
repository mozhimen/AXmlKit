...
internal object AttrsParser : IAttrsParser2<MNavBarAttrs> {
    ...
    private val SUBTITLE_TEXT_COLOR = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_gray_d2d4d7)
    private val SUBTITLE_TEXT_MARGIN_TOP = 1f.dp2px().toInt()
    private val LINE_COLOR = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_gray_eeeeee)
    ...
    override fun parseAttrs(context: Context, attrs: AttributeSet?, defStyleAttr: Int): MNavBarAttrs {
        ...
        UtilKTheme.resolveAttribute( R.attr.LayoutKNavBar_StyleK_LayoutKNavBar, typedValue, true,context)
