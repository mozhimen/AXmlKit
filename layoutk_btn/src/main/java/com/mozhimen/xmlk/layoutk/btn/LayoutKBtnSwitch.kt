package com.mozhimen.xmlk.layoutk.btn
...
import com.mozhimen.kotlin.utilk.androidx.lifecycle.runOnMainScope
...
class LayoutKBtnSwitch @JvmOverloads constructor(
    ...
    private val _attrs: LayoutKBtnSwitchAttrs by lazy_ofNone { LayoutKBtnSwitchAttrsParser.parseAttrs(context, attrs) }
