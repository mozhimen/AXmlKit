    ...
    inner class SideContentAdapter(
        ...
        private fun bindContentView(holder: VHKRecycler, position: Int) {
            ...
            holder.findViewByIdOrNull<ImageView>(R.id.layoutk_side_content_item_img)
                ?.loadImageComplexGlide(contentMo?.contentImageUrl ?: "", placeholder = com.mozhimen.uicorek.layoutk.refresh.R.drawable.layoutk_refresh_loading, error = com.mozhimen.uicorek.layoutk.empty.R.drawable.layoutk_empty)
        }
