...
internal object SideAttrsParser : IAttrsParser<MSideAttrs> {
    ...
    private val MENU_ITEM_TEXT_COLOR = UtilKRes.getColor(com.mozhimen.uicorek.R.color.cok_blue_287ff1)
    private val MENU_ITEM_TEXT_COLOR_SELECT = UtilKRes.getColor(com.mozhimen.uicorek.R.color.cok_blue_287ff1)
    private val MENU_ITEM_BG_COLOR = UtilKRes.getColor(android.R.color.white)
    private val MENU_ITEM_BG_COLOR_SELECT = UtilKRes.getColor(com.mozhimen.uicorek.R.color.cok_blue_e8f3ff)
    ...
    private val SUB_TEXT_COLOR = UtilKRes.getColor(com.mozhimen.uicorek.R.color.cok_blue_287ff1)
    ...
    private val CONTENT_TEXT_COLOR = UtilKRes.getColor(com.mozhimen.uicorek.R.color.cok_blue_287ff1)
