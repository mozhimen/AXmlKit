...
import com.mozhimen.xmlk.layoutk.banner.commons.IBannerAdapter
import com.mozhimen.xmlk.layoutk.banner.commons.IBannerBindListener
import com.mozhimen.xmlk.layoutk.banner.commons.IBannerItemClickListener
...
class BannerAdapter(private var _context: Context) : PagerAdapter(), IBannerAdapter {
    ...
    override fun setIntResLayout(@LayoutRes intResLayout: Int) {
        _intResLayout = intResLayout
    }
    ...
    private fun createView(layoutInflater: LayoutInflater, parent: ViewGroup?): View {
        require(_intResLayout != -1) { "$TAG you must be set setIntResLayout first" }
        return layoutInflater.inflate(_intResLayout, parent, false)
    }
}