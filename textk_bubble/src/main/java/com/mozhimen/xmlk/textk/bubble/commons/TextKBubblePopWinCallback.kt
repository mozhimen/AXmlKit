package com.mozhimen.xmlk.textk.bubble.commons
...
import com.mozhimen.xmlk.textk.bubble.annors.ARelativeHorizontal
import com.mozhimen.xmlk.textk.bubble.annors.ARelativeVertical
import com.mozhimen.xmlk.textk.bubble.mos.MRelativePos
...
open class TextKBubblePopWinCallback(contentView: View, bubbleView: ITextKBubble) : PopupWindow(
    ...
    fun showArrowTo(anchorView: View, direction: EArrowDirection, margin: Int) {
        val relativePos: MRelativePos = when (direction) {
            EArrowDirection.Up -> MRelativePos(ARelativeHorizontal.CENTER_HORIZONTAL, ARelativeVertical.BELOW)
            EArrowDirection.Down -> MRelativePos(ARelativeHorizontal.CENTER_HORIZONTAL, ARelativeVertical.ABOVE)
            EArrowDirection.Left -> MRelativePos(ARelativeHorizontal.TO_RIGHT_OF, ARelativeVertical.CENTER_VERTICAL)
            EArrowDirection.Right -> MRelativePos(ARelativeHorizontal.TO_LEFT_OF, ARelativeVertical.CENTER_VERTICAL)
            else -> MRelativePos(ARelativeHorizontal.CENTER_HORIZONTAL, ARelativeVertical.CENTER_VERTICAL)
        }
