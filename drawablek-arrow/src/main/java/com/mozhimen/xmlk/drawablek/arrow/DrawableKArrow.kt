package com.mozhimen.xmlk.drawablek.arrow
...
import com.mozhimen.xmlk.drawablek.arrow.helpers.ShapeDrawer
...
class DrawableKArrow : Drawable(), IArrow {
    private val _shapeDrawer: ShapeDrawer by lazy_ofNone { ShapeDrawer() }
