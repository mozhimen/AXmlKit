...
internal object SideAttrsParser : IAttrsParser<MSideAttrs> {
    ...
    private val MENU_ITEM_TEXT_COLOR = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_287ff1)
    private val MENU_ITEM_TEXT_COLOR_SELECT = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_287ff1)
    private val MENU_ITEM_BG_COLOR = UtilKRes.gainColor(android.R.color.white)
    private val MENU_ITEM_BG_COLOR_SELECT = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_e8f3ff)
    ...
    private val SUB_TEXT_COLOR = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_287ff1)
    ...
    private val CONTENT_TEXT_COLOR = UtilKRes.gainColor(com.mozhimen.uik.R.color.cok_blue_287ff1)
