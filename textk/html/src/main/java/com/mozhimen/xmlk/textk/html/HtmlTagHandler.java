            ...
            if (tag.equalsIgnoreCase(UNORDERED_LIST)) {
                ...
                final String spannedText = output.subSequence(spanStart, spanEnd).toString();
                    ...
                    public void onClick(View widget) {
                        if (onClickATagListenerProvider != null && onClickATagListenerProvider.provideTagClickListener() != null) {
                            UtilKLogWrapper.d("HtmlTagHandler>>>>>", "onClick: widget " + widget + "spannedText" + spannedText + " getURL() " + getURL());
