package com.mozhimen.xmlk.textk.bubble
...
import com.mozhimen.xmlk.textk.bubble.commons.ITextKBubbleListener
...
class TextKBubbleDelegate(private val _context: Context) : ITextKBubble, ILayoutK {
    ...
    override fun setPadding(left: Float, top: Float, right: Float, bottom: Float) {
        ...
        if (UtilKBuildVersion.get_SDK_INT() <= CVersCode.V_16_41_JB) {
