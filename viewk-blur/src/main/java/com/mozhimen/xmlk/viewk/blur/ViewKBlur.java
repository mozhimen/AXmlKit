package com.mozhimen.xmlk.viewk.blur;
...
import com.mozhimen.xmlk.viewk.blur.impls.BlockingBlurController;
import com.mozhimen.xmlk.viewk.blur.impls.NoOpController;

/**
 * FrameLayout that blurs its underlying content.
 * Can have children and draw them over blurred background.
 */
public class ViewKBlur extends FrameLayout {

    private static final String TAG = ViewKBlur.class.getSimpleName();
    ...
    public ViewKBlur(Context context) {
        super(context);
        init(null, 0);
    }

    public ViewKBlur(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public ViewKBlur(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr);
    }

    private void init(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ViewKBlur, defStyleAttr, 0);
        round = a.getBoolean(R.styleable.ViewKBlur_viewKBlur_hasRound, false);
        roundCornerRadius = a.getDimensionPixelSize(R.styleable.ViewKBlur_viewKBlur_roundRadius, 0);
        barrierColor = a.getColor(R.styleable.ViewKBlur_viewKBlur_barrierColor, Color.TRANSPARENT);
        overlayColor = a.getColor(R.styleable.ViewKBlur_viewKBlur_overlayColor, Color.TRANSPARENT);
        overlayBlendMode = a.getColor(R.styleable.ViewKBlur_viewKBlur_overlayBlendMode, SRC_OVER);
        a.recycle();
     ...
     * @return {@link ViewKBlur} to setup needed params.
     */
