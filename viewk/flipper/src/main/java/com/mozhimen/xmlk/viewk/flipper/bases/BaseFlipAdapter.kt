package com.mozhimen.xmlk.viewk.flipper.bases
...
import com.mozhimen.xmlk.viewk.flipper.ViewKFlipper
...
abstract class BaseFlipAdapter<T>(@LayoutRes private val _intLayoutId: Int, private var _datas: List<T>? = null) : BaseWakeBefDestroyLifecycleObserver() {
     ...
     * 自定义跑马灯的Item布局
     */
    fun onCreateView(parent: ViewKFlipper): View =
