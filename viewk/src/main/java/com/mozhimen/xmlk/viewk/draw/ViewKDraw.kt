package com.mozhimen.xmlk.viewk.draw
...
import com.mozhimen.xmlk.viewk.draw.mos.MyPath
import com.mozhimen.xmlk.viewk.draw.mos.PaintOptions
 ...
 * @Version 1.0
 */
class ViewKDraw(context: Context, attrs: AttributeSet) : BaseViewK(context, attrs) {
