 ...
 * @Version 1.0
 */
class ViewKArcRotate @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private var _arcWidth = 2f.dp2pxI()
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        _arcStartColor =
            typedArray.getColor(R.styleable.ViewKArcRotate_viewKArcRotate_arcStartColor, _arcStartColor)
        _arcEndColor =
            typedArray.getColor(R.styleable.ViewKArcRotate_viewKArcRotate_arcEndColor, _arcEndColor)
        _arcWidth =
            typedArray.getDimensionPixelSize(R.styleable.ViewKArcRotate_viewKArcRotate_arcWidth, _arcWidth)
        _angleStep =
            typedArray.getInteger(R.styleable.ViewKArcRotate_viewKArcRotate_angleStep, _angleStep)
        _arcNum =
            typedArray.getInteger(R.styleable.ViewKArcRotate_viewKArcRotate_arcNum, _arcNum)
        _animTime =
            typedArray.getInteger(R.styleable.ViewKArcRotate_viewKArcRotate_animTime, _animTime)
        _angleInterval =
            typedArray.getInteger(R.styleable.ViewKArcRotate_viewKArcRotate_angleInterval, _angleInterval)
        typedArray.recycle()
    }
