...
internal object AttrsParser {
    ...
    val SLIDER_ROD_LEFT_COLOR = UtilKRes.gainColor(com.mozhimen.uicorek.R.color.cok_blue_287ff1)
    val SLIDER_ROD_RIGHT_COLOR = UtilKRes.gainColor(com.mozhimen.uicorek.R.color.cok_gray_eeeeee)
    val ROD_SCROLL_ENABLE = true
    val ROD_COLOR = Color.WHITE
    val ROD_COLOR_INSIDE = UtilKRes.gainColor(com.mozhimen.uicorek.R.color.cok_blue_287ff1)
