...
class ViewKRadarWave @JvmOverloads constructor(
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        _radarColor =
            typedArray.getColor(R.styleable.ViewKRadarWave_viewKRadarWave_radarColor, _radarColor)
        _waveColor =
            typedArray.getColor(R.styleable.ViewKRadarWave_viewKRadarWave_waveColor, _waveColor)
        _waveCount =
            typedArray.getInteger(R.styleable.ViewKRadarWave_viewKRadarWave_waveCount, _waveCount)
        _isWaveOverTurn =
            typedArray.getBoolean(R.styleable.ViewKRadarWave_viewKRadarWave_isWaveOverTurn, _isWaveOverTurn)
        _moveAngleStep =
            typedArray.getInteger(R.styleable.ViewKRadarWave_viewKRadarWave_angleStep, _moveAngleStep)
        _animTime =
            typedArray.getInteger(R.styleable.ViewKRadarWave_viewKRadarWave_animTime, _animTime)
        typedArray.recycle()
    }
