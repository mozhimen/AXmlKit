...
class RecyclerKItemLoadMore(private val index: Int?=null) : RecyclerKItem<VHKRecycler>() {
    ...
    override fun getItemView(parent: ViewGroup): View {
        ...
        textView.setTextColor(UtilKRes.gainColor(com.mozhimen.uicorek.R.color.cok_blue_e8f3ff))
        textView.applyTextStyle(Typeface.BOLD)
        textView.gravity = Gravity.CENTER
        textView.setBackgroundColor(UtilKRes.gainColor(com.mozhimen.uicorek.R.color.cok_blue_4785ef))
