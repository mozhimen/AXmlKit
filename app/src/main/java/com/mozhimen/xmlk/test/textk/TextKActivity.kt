...
class TextKActivity : BaseActivityVDB<ActivityTextkBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            vdb.textkProgress2.setContentAndProgress("0%", 0)
            delay(2000)
            vdb.textkProgress2.setContentAndProgress("20%", 20)
            delay(2000)
            vdb.textkProgress2.setContentAndProgress("40%", 40)
            delay(2000)
            vdb.textkProgress2.setContentAndProgress("50%", 50)
            delay(2000)
            vdb.textkProgress2.setContentAndProgress("60%", 60)
            delay(2000)
            vdb.textkProgress2.setContentAndProgress("80%", 80)
            delay(2000)
            vdb.textkProgress2.setContentAndProgress("100%", 100)
